...
public final class o extends AbstractC0837b {

    /* renamed from: a, reason: collision with root package name */
    public final /* synthetic */ int f5283a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ p f5284b;
        ...
        switch (this.f5283a) {
            case 0:
                ...
                if (rVar.f5619g == null) {
                    ...
                    cVar.c(7, r4.intValue());
                }
                if (rVar.f5620h == null) {
                    cVar.b(8);
                } else {
                    cVar.c(8, r4.intValue());
                }
                if (rVar.f5621i == null) {
                    cVar.b(9);
                } else {
                    cVar.c(9, r4.intValue());
                }
                if (rVar.j == null) {
                    cVar.b(10);
                } else {
                    cVar.c(10, r4.intValue());
                }
                if (rVar.k == null) {
                    cVar.b(11);
                } else {
                    cVar.c(11, r4.intValue());
                }
                if (rVar.f5622l == null) {
                    cVar.b(12);
                } else {
                ...
                if (rVar.f5624n == null) {
                    ...
                    cVar.c(14, r4.intValue());
                }
                if (rVar.f5625o == null) {
                    cVar.b(15);
                } else {
                    cVar.c(15, r4.intValue());
                }
                if (rVar.f5626p == null) {
                    cVar.b(16);
                } else {
                    cVar.c(16, r4.intValue());
                }
                if (rVar.f5627q == null) {
                    cVar.b(17);
                } else {
                    cVar.c(17, r4.intValue());
                }
    ...
    public final String g() {
        switch (this.f5283a) {
            case 0:
                return "UPDATE OR ABORT `condition_table` SET `id` = ?,`eventId` = ?,`name` = ?,`type` = ?,`priority` = ?,`path` = ?,`area_left` = ?,`area_top` = ?,`area_right` = ?,`area_bottom` = ?,`threshold` = ?,`detection_type` = ?,`shouldBeDetected` = ?,`detection_area_left` = ?,`detection_area_top` = ?,`detection_area_right` = ?,`detection_area_bottom` = ?,`broadcast_action` = ?,`counter_name` = ?,`counter_comparison_operation` = ?,`counter_operation_value_type` = ?,`counter_value` = ?,`counter_value_counter_name` = ?,`timer_value_ms` = ?,`timer_restart_when_reached` = ? WHERE `id` = ?";
            default:
                return "UPDATE OR ABORT `condition_table` SET `id` = ?,`eventId` = ?,`name` = ?,`type` = ?,`priority` = ?,`path` = ?,`area_left` = ?,`area_top` = ?,`area_right` = ?,`area_bottom` = ?,`threshold` = ?,`detection_type` = ?,`shouldBeDetected` = ?,`detection_area_left` = ?,`detection_area_top` = ?,`detection_area_right` = ?,`detection_area_bottom` = ?,`broadcast_action` = ?,`counter_name` = ?,`counter_comparison_operation` = ?,`counter_operation_value_type` = ?,`counter_value` = ?,`counter_value_counter_name` = ?,`timer_value_ms` = ?,`timer_restart_when_reached` = ? WHERE `id` = ?";
        }
    }
