...
public final class C0296g extends AbstractC0837b {

    /* renamed from: a, reason: collision with root package name */
    public final /* synthetic */ int f5257a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ C0297h f5258b;

    public /* synthetic */ C0296g(C0297h c0297h, int i4) {
        this.f5257a = i4;
        this.f5258b = c0297h;
    }
    ...
    public final void b(D0.c cVar, Object obj) {
        ...
        switch (this.f5257a) {
            case 0:
                ...
                C0297h c0297h = this.f5258b;
                cVar.k(C0297h.u(c0297h, enumC0305d), 5);
                ...
                if (c0304c.f5564g == null) {
                    ...
                    cVar.c(7, r3.intValue());
                }
                if (c0304c.f5565h == null) {
                    cVar.b(8);
                } else {
                    cVar.c(8, r3.intValue());
                }
                ...
                if (c0304c.k == null) {
                    ...
                    cVar.c(11, r3.intValue());
                }
                if (c0304c.f5567l == null) {
                    cVar.b(12);
                } else {
                    cVar.c(12, r3.intValue());
                }
                ...
                if (c0304c.f5569n == null) {
                    ...
                    cVar.c(14, r3.intValue());
                }
                if (c0304c.f5570o == null) {
                    cVar.b(15);
                } else {
                    cVar.c(15, r3.intValue());
                }
                if (c0304c.f5571p == null) {
                    cVar.b(16);
                } else {
                    cVar.c(16, r3.intValue());
                }
                ...
                if (enumC0306e == null) {
                    ...
                    cVar.k(C0297h.w(c0297h, enumC0306e), 27);
                }
                ...
                if (c0304c.f5555H == null) {
                    ...
                    cVar.c(34, r2.intValue());
                }
                N n3 = c0304c.f5556I;
                if (n3 == null) {
                    cVar.b(35);
                } else {
                    cVar.k(C0297h.C(c0297h, n3), 35);
                }
            ...
            case 1:
                ...
                cVar.c(1, j5);
                cVar.c(2, f8.f5513b);
                cVar.k(C0297h.A(this.f5258b, f8.f5514c), 3);
                cVar.k(f8.f5515d, 4);
                cVar.k(f8.f5516e, 5);
                cVar.c(6, j5);
                return;
            default:
                ...
                cVar.c(1, j8);
                cVar.c(2, a3.f5500b);
                cVar.k(C0297h.y(this.f5258b, a3.f5501c), 3);
                cVar.c(4, a3.f5502d);
                cVar.c(5, j8);
                return;
        }
    ...
    public final String g() {
        switch (this.f5257a) {
            case 0:
                return "UPDATE OR ABORT `action_table` SET `id` = ?,`eventId` = ?,`priority` = ?,`name` = ?,`type` = ?,`clickPositionType` = ?,`x` = ?,`y` = ?,`clickOnConditionId` = ?,`pressDuration` = ?,`clickOffsetX` = ?,`clickOffsetY` = ?,`fromX` = ?,`fromY` = ?,`toX` = ?,`toY` = ?,`swipeDuration` = ?,`pauseDuration` = ?,`isAdvanced` = ?,`isBroadcast` = ?,`intent_action` = ?,`component_name` = ?,`flags` = ?,`toggle_all` = ?,`toggle_all_type` = ?,`counter_name` = ?,`counter_operation` = ?,`counter_operation_value_type` = ?,`counter_operation_value` = ?,`counter_operation_counter_name` = ?,`notification_message_type` = ?,`notification_message_text` = ?,`notification_message_counter_name` = ?,`notification_importance` = ?,`system_action_type` = ?,`text_value` = ?,`text_validate_input` = ? WHERE `id` = ?";
            case 1:
                return "UPDATE OR ABORT `intent_extra_table` SET `id` = ?,`action_id` = ?,`type` = ?,`key` = ?,`value` = ? WHERE `id` = ?";
            default:
                return "UPDATE OR ABORT `event_toggle_table` SET `id` = ?,`action_id` = ?,`toggle_type` = ?,`toggle_event_id` = ? WHERE `id` = ?";
        }
    }
}
