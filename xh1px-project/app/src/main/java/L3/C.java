...
public final class C implements InterfaceC0233f {
    ...
    public final /* synthetic */ W0.d f2784e;
    ...
    public final Object x(InterfaceC0234g interfaceC0234g, InterfaceC0617c interfaceC0617c) {
        switch (this.f2783d) {
            case 0:
                Object x8 = this.f2784e.x(new y2.j(interfaceC0234g, 1), interfaceC0617c);
                if (x8 != EnumC0646a.f10656d) {
                    return Z5.y.f7506a;
                }
                return x8;
            case 1:
                Object x9 = this.f2784e.x(new E(interfaceC0234g, 2), interfaceC0617c);
                if (x9 != EnumC0646a.f10656d) {
                    return Z5.y.f7506a;
                }
                return x9;
            case Z.g.FLOAT_FIELD_NUMBER /* 2 */:
                Object x10 = this.f2784e.x(new E(interfaceC0234g, 4), interfaceC0617c);
                if (x10 != EnumC0646a.f10656d) {
                    return Z5.y.f7506a;
                }
                return x10;
            default:
                Object x11 = this.f2784e.x(new E(interfaceC0234g, 6), interfaceC0617c);
