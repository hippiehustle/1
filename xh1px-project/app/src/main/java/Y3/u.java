...
public final class u implements InterfaceC0233f {
    ...
    public final /* synthetic */ W0.c f7154e;

    public /* synthetic */ u(W0.c cVar, int i4) {
        this.f7153d = i4;
        this.f7154e = cVar;
    }
    ...
    public final Object x(InterfaceC0234g interfaceC0234g, InterfaceC0617c interfaceC0617c) {
        switch (this.f7153d) {
            case 0:
                Object x8 = this.f7154e.x(new X3.t(interfaceC0234g, 9), interfaceC0617c);
                if (x8 != EnumC0646a.f10656d) {
                    return Z5.y.f7506a;
                }
                return x8;
            default:
                Object x9 = this.f7154e.x(new X3.t(interfaceC0234g, 11), interfaceC0617c);
